...
**Abstract**
We investigate the optimal design of policy rules for integrating Generative Artificial Intelligence (AI) into middle school education. Using a Randomized Controlled Trial (RCT) across two urban middle schools in China, we causally estimate the effects of two distinct policy components: AI Guideline (providing students with instructions) and AI Conditional Use (a restrictive framework, applied to the AI rate in writing). While we find a statistically insignificant average treatment effect on overall academic performance, the AI Guidance intervention significantly increased students’ exposure to AI use, proxied by increased frequency. Crucially, the Conditional Use restriction generated positive academic spillovers: female students experienced improved math scores, with the largest benefits observed in the group receiving both the Guideline and the Restriction. We propose that this differential impact is rooted in a compliance mechanism. Descriptive evidence shows that girls used AI tools more frequently at a baseline and, during the experiment, demonstrated greater adherence to the guidelines. This suggests that the combination of guideline and constraint successfully steered girls toward a more effective use of AI tools, which explains the observed positive academic spillovers to their math scores. 
...
**Rewiring Opportunity: How Improved Internet Infrastructure Reduces Intra-City Income Inequality in China** _(Submitted)_
